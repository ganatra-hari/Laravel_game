...
<html lang="en">
  ...
  <head>
    ...
    <title>Bolt Gaming - Product Detail</title>
            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                      ...
                      <li><a href="pro" class="active">Product Details</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <span class="breadcrumb"><a href="home">Home</a>  >  <a href="shop">Shop</a>  >  Ghost Of Tsushima</span>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 align-self-center">
          ...
          <form >
            ...
            <button > <a href="https://nephobox.com/s/1dxkt8Ff7-waeNWeqATlL3Q" style="color: white">Download</a> </button>
          </form>
          <ul> 
            <li><span>Game ID:</span>---</li>
            <li><span>Genre:</span> <a href="#">Action</a>, <a href="#">Battle</a>, <a href="#">Offline</a></li>
            <li><span>Multi-tags:</span> <a href="#">Mission</a>, <a href="#">Story</a>, <a href="#">Single Player</a></li>
          </ul>
        </div>
        <div class="col-lg-12">
          <div class="sep"></div>
            ...
            <div class="row">
              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                 <p>- Detroit: Become Human, the award-winning video game production from Quantic Dream, is finally available on Steam! Featuring world-renowned actors including Jesse Williams (Grey’s Anatomy), Clancy Brown (Carnivale), Lance Henriksen (Aliens), Bryan Dechart (True Blood) and Valorie Curry (Twilight). 
                ...
                - Shape an ambitious branching narrative, where your decisions not only determine the fate of the three main characters, but that of the entire city of Detroit. How you control Kara, Connor and Markus can mean life or death – and if one of them pays the ultimate price, the story still continues…<br></p>
                <br><br> 
              </div>
                </div>
      ...
      <div class="row">
        ...
        <div class="col-lg col-sm-6 col-xs-12">
          <div class="item">
            <h4>Action</h4>
            <div class="thumb">
              <a href="bmw"><img src="/images/bmw.jpg" alt=""></a>
            </div>
          </div>
        </div>
        <div class="col-lg col-sm-6 col-xs-12">
          <div class="item">
            <h4>Action</h4>
            <div class="thumb">
              <a href="uc4"><img src="/images/uc4.jpg" alt=""></a>
            </div>
          </div>
        </div>
        <div class="col-lg col-sm-6 col-xs-12">
