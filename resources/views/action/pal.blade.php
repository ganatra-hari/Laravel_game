  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h3>Palworld</h3>
          <span class="breadcrumb"><a href="home">Home</a>  >  <a href="shop">Shop</a>  >  Palworld</span>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 align-self-center">
          <h4>Palworld</h4>
          <span class="price"><em>₹1,300</em> Free</span>
          <p></p>
          <form >
          ...
          <ul> 
            <li><span>Game ID:</span>palwor69</li>
