    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <span class="breadcrumb"><a href="home">Home</a>  >  <a href="shop">Shop</a>  >  Uncharted : The Lost Legacy</span>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 align-self-center">
          ...
          <span class="price"><em>₹3,299</em> Free</span>
          <p></p>
          <form >
            <input type="qty" class="form-control" id="1" aria-describedby="quantity" placeholder="1">
            <button ><i class=""><a href="https://nephobox.com/s/18-Q3PgqjmbfUI-lZNAj4cA" style="color: white">Download</a></i> </button>
          </form>
          <ul> 
...
-  Soundtrack artists The Alchemist and Oh No return as hosts of the new radio station, The Lab FM. The station features new and exclusive music from the production duo based on and inspired by the game’s original soundtrack. Collaborating guest artists include Earl Sweatshirt, Freddie Gibbs, Little Dragon, Killer Mike, Sam Herring from Future Islands, and more. Players can also discover Los Santos and Blaine County while enjoying their own music through Self Radio, a new radio station that will host player-created custom soundtracks. <br></p>
                </div>
                </div>
