  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h3>FarCry 3</h3>
          <span class="breadcrumb"><a href="home">Home</a>  >  <a href="shop">Shop</a>  >  FarCry 3</span>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 align-self-center">
          ...
          <form >
            ...
            <button > <a href="https://nephobox.com/s/19C1GzSz3W35mBluERUoSMQ" style="color: white">Download</a> </button>
          </form>
          <ul> 
            <li><span>Game ID:</span>---</li>
            <li><span>Genre:</span> <a href="#">Action</a>, <a href="#">Robots</a>, <a href="#">Offline</a></li>
      ...
      <div class="row">
        ...
        <div class="col-lg col-sm-6 col-xs-12">
          <div class="item">
            <h4>Action</h4>
            <div class="thumb">
              <a href="rdr"><img src="/images/rdd.jpg" alt=""></a>
            </div>
          </div>
        </div>
      </div>
