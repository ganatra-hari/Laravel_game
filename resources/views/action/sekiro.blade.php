  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h3>Sekiro</h3>
          <span class="breadcrumb"><a href="home">Home</a>  >  <a href="shop">Shop</a>  >  Sekiro : Shadow Die Twice</span>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 align-self-center">
          ...
          <form >
            ...
            <button ><i class=""><a href="https://nephobox.com/s/19C1GzSz3W35mBluERUoSMQ" style="color: white">Download</a></i> </button>
          </form>
          <ul>
            <li><span>Game ID:</span>sekirobot10</li>
            <li><span>Genre:</span> <a href="#">Action</a>, <a href="#"></a>, <a href="#">Offline</a></li>
            <li><span>Multi-tags:</span> <a href="#">Mission</a>, <a href="#">Story</a>, <a href="#"></a></li>
          </ul>
        </div>
        <div class="col-lg-12">
          <div class="sep"></div>
            ...
            <div class="row">
              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                 <p>- Reflection and Gauntlet of Strength - new boss challenge modes
...
Explore late 1500s Sengoku Japan, a brutal period of constant life and death conflict, as you come face to face with larger than life foes in a dark and twisted world. Unleash an arsenal of deadly prosthetic tools and powerful ninja abilities while you blend stealth, vertical traversal, and visceral head to head combat in a bloody confrontation.<br></p>
                </div>
                </div>
