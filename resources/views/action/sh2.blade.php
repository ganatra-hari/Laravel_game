  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h3>Silent Hill 2</h3>
          <span class="breadcrumb"><a href="home">Home</a>  >  <a href="path">Shop</a>  >  Silent Hill 2</span>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 align-self-center">
          ...
          <form >
            ...
            <button ><i class=""><a href="https://nephobox.com/s/1O9XYkJAhdBXRoIEsB8Gagw" style="color: white">Download</a></i> </button>
          </form>
          <ul> 
            <li><span>Game ID:</span>---</li>
            <li><span>Genre:</span> <a href="#">Horror</a>, <a href="#">Open World</a>, <a href="#">Offline</a></li>
