  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h3>God Of War</h3>
          <span class="breadcrumb"><a href="home">Home</a>  >  <a href="shop">Shop</a>  >  God Of War</span>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 align-self-center">
          <h4>God Of War</h4>
          <span class="price"><em>₹1,259</em> Free</span>
          <p></p>
          <form >
            <input type="qty" class="form-control" id="1" aria-describedby="quantity" placeholder="1">
            <button > <a href="https://nephobox.com/s/10I9RrZx-wMdNiM3Y34BHxw" style="color: white">Download</a> </button>
          </form>
          <ul> 
            <li><span>Game ID:</span>---</li>
            <li><span>Genre:</span> <a href="#">Action</a>, <a href="#">Super Powers</a>, <a href="#">Online</a></li>
            <li><span>Multi-tags:</span> <a href="#">Mission</a>, <a href="#">Story</a>, <a href="#">MultiPlayer</a></li>
          </ul>
        </div>
        <div class="col-lg-12">
          <div class="sep"></div>
