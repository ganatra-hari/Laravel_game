  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h3>GTA V</h3>
          <span class="breadcrumb"><a href="home">Home</a>  >  <a href="shop">Shop</a>  >  GTA V</span>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 align-self-center">
          ...
          <form >
            ...
            <button ><i class=""><a href="https://nephobox.com/s/1MrQ9VHPmDXYvBCiwPCwDnQ" style="color: white">Download</a></i> </button>
          </form>
          <ul> 
            <li><span>Game ID:</span>GTASLOW106</li>
            <li><span>Genre:</span> <a href="#">Action</a>, <a href="#">Open World</a>, <a href="#">Online</a></li>
