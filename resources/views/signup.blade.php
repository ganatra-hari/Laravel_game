            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <!-- <li><a href="home">Home</a></li>
                      ...
                      <li><a href="signup">New User Adding...</a></li>
                  </ul>   
  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h3>Signup Page</h3>
          <span class="breadcrumb"><a href="#">Home</a>  >  Signup Page</span>
        </div>
      </div>
    </div>
  </div>
...
<button type="Login" name="Login Page" class="btn btn-info btn-lg"><a href="login" style="color: black">Login Page</a></button>
