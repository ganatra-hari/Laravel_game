...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <span class="breadcrumb"><a href="#">Home</a>  > Admin Login Page</span>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container" >
    <div class="jumbotron">
    <form action="{{url('admin_loginprocess')}}" method="post" class="signup-page-form ">
...
<input type="adminname" name="adminname" required><br><br>

<label>Enter Your Password:</label><br>
<input type="a_password" name="a_password" required><br><br>
